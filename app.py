...
# show the title
st.title('Titanic App By Xinyi Bu')
...
axes[0].set_title('Ticket Price for Pclass 1')
axes[0].set_xlabel('PClass')
axes[0].set_ylabel('Fare')

axes[1].set_title('Ticket Price for Pclass 2')
axes[1].set_xlabel('PClass')
axes[1].set_ylabel('Fare')

axes[2].set_title('Ticket Price for Pclass 3')
